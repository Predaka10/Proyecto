...
public class IS12DAO {
    ...
    public void addTarea(Tareas tarea) throws SQLException {
        ...
        String sql = "insert into tareas (Usuario, asignacion,cod_proyecto)" + "values" + "('" +tarea.getUser()+ "','" + tarea.getAsignacion() + "','"+tarea.getCod_proyect()+"')";
        mysql.execute(sql);
        mysql.closeExecute();
    }
    ...
    public void deleteProyecto(Proyecto proyecto) throws SQLException {
        mysql = new MySQLDB();
        String sql = "delete from tareas where codigo = '" + proyecto.getCodigo() + "'";
        mysql.execute(sql);
        mysql.closeExecute();
    ...
    public void updateTarea(Tareas tarea) throws SQLException {
        mysql = new MySQLDB();
        Users user = new Users();
        String sql = "update tareas set asignacion ='" + tarea.getAsignacion() +"' where Usuario ='" + tarea.getUser()+ "'";
        mysql.execute(sql);
        mysql.closeExecute();
    }
    ...
    public void updateProyecto(Proyecto proyecto) throws SQLException {
        mysql = new MySQLDB();
        String sql = "update proyectos set nombre del proyecto ='" + proyecto.getNombre() + "'  where codigo ='" + proyecto.getCodigo() + "'";
        mysql.execute(sql);
        mysql.closeExecute();
